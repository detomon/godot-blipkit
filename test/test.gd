...
func _init_track() -> void:
	...
	assem.put(BlipKitAssembler.INSTR_STORE, 0, 0)
	...
	assem.put(BlipKitAssembler.INSTR_TICK, 48)
	assem.put(BlipKitAssembler.INSTR_ATTACK, float(BlipKitTrack.NOTE_D_SH_1))
	assem.put(BlipKitAssembler.INSTR_TICK, 24)
	assem.put(BlipKitAssembler.INSTR_RELEASE)
	assem.put(BlipKitAssembler.INSTR_TICK, 24)
	assem.put(BlipKitAssembler.INSTR_ATTACK, float(BlipKitTrack.NOTE_G_1))
	assem.put(BlipKitAssembler.INSTR_TICK, 24)
	assem.put(BlipKitAssembler.INSTR_RELEASE)
	assem.put(BlipKitAssembler.INSTR_TICK, 24)
	...
	assem.put(BlipKitAssembler.INSTR_STORE, 0, 1)
	assem.put(BlipKitAssembler.INSTR_ATTACK, float(BlipKitTrack.NOTE_C_1))
	assem.put(BlipKitAssembler.INSTR_TICK, 48)
	assem.put(BlipKitAssembler.INSTR_RELEASE)
	assem.put(BlipKitAssembler.INSTR_TICK, 48)
	...
	assem.put(BlipKitAssembler.INSTR_STORE, 0, 2)
	assem.put(BlipKitAssembler.INSTR_ATTACK, float(BlipKitTrack.NOTE_D_SH_1))
	assem.put(BlipKitAssembler.INSTR_TICK, 48)
	assem.put(BlipKitAssembler.INSTR_RELEASE)
	assem.put(BlipKitAssembler.INSTR_TICK, 48)
	...
	assem.put(BlipKitAssembler.INSTR_RELEASE)
	assem.put(BlipKitAssembler.INSTR_TICK, 24)
	assem.put(BlipKitAssembler.INSTR_ATTACK, float(BlipKitTrack.NOTE_A_SH_1))
	assem.put(BlipKitAssembler.INSTR_TICK, 24)
	assem.put(BlipKitAssembler.INSTR_RELEASE)
	assem.put(BlipKitAssembler.INSTR_TICK, 24)
	...
	assem.put(BlipKitAssembler.INSTR_STORE, 0, 3)
	assem.put(BlipKitAssembler.INSTR_ATTACK, float(BlipKitTrack.NOTE_D_1))
	assem.put(BlipKitAssembler.INSTR_TICK, 48)
	assem.put(BlipKitAssembler.INSTR_RELEASE)
	assem.put(BlipKitAssembler.INSTR_TICK, 48)
	assem.put(BlipKitAssembler.INSTR_ATTACK, float(BlipKitTrack.NOTE_F_SH_1))
	assem.put(BlipKitAssembler.INSTR_TICK, 24)
	assem.put(BlipKitAssembler.INSTR_RELEASE)
	assem.put(BlipKitAssembler.INSTR_TICK, 24)
	assem.put(BlipKitAssembler.INSTR_ATTACK, float(BlipKitTrack.NOTE_A_1))
	assem.put(BlipKitAssembler.INSTR_TICK, 24)
	assem.put(BlipKitAssembler.INSTR_RELEASE)
	assem.put(BlipKitAssembler.INSTR_TICK, 24)
