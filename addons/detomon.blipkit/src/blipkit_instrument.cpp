...
void BlipKitInstrument::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("set_sequence_adsr", "attack", "decay", "sustain", "release"), &BlipKitInstrument::set_sequence_adsr);
}
...
void BlipKitInstrument::set_sequence_pitch(PackedFloat32Array p_values, int p_sustain_offset, int p_sustain_length) {
	set_sequence_float(Sequence::SEQUENCE_PITCH, p_values, p_sustain_offset, p_sustain_length, (real_t)BK_FINT20_UNIT);
}

void BlipKitInstrument::set_sequence_volume(PackedFloat32Array p_values, int p_sustain_offset, int p_sustain_length) {
	set_sequence_float(Sequence::SEQUENCE_VOLUME, p_values, p_sustain_offset, p_sustain_length, (real_t)BK_MAX_VOLUME);
}

void BlipKitInstrument::set_sequence_panning(PackedFloat32Array p_values, int p_sustain_offset, int p_sustain_length) {
	set_sequence_float(Sequence::SEQUENCE_PANNING, p_values, p_sustain_offset, p_sustain_length, (real_t)BK_MAX_VOLUME);
}

void BlipKitInstrument::set_sequence_duty_cycle(PackedInt32Array p_values, int p_sustain_offset, int p_sustain_length) {
	set_sequence_int(Sequence::SEQUENCE_PITCH, p_values, p_sustain_offset, p_sustain_length);
}

void BlipKitInstrument::set_sequence_adsr(int p_attack, int p_decay, real_t p_sustain, int p_release) {
